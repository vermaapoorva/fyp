...
SCENE_FILE = join(dirname(abspath(__file__)), 'impl_5_scene.ttt')

#################################################################################################
################################   SETTING UP THE ENVIRONMENT   #################################
#################################################################################################

class RobotEnv5(gym.Env):
    """Custom Environment that follows gym interface"""

    def __init__(self, headless=True):
        super(RobotEnv5, self).__init__()
        print("init")
...
def train():
    ...
    model = PPO('CnnPolicy', env, verbose=0, tensorboard_log=tensorboard_log_dir)
