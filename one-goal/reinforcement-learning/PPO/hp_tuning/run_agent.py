...
if __name__ == '__main__':
    ...
    for amount_of_data in range(6, 11):
        amount_of_data *= 1000000
        # amount_of_data -= 500000
        for final_seed in [1019, 2603, 210423]:
            for scene_num in range(len(scenes)):

                evaluation_file = f"/vol/bitbucket/av1019/PPO/final_models/results/final_results_{amount_of_data}_scene_{scene_num}_seed_{final_seed}.json"
