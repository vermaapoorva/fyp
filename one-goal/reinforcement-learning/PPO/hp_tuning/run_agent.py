...
if __name__ == '__main__':
    ...
    net_arch_indexes = [4, 5]

    # scene_indexes = [4]
    scene_indexes = [0, 1, 2, 3, 4, 5]
    ...
    for i in net_arch_indexes:
        ...
        for scene_num in scene_indexes:
            ...
            print(f"Running model {i} on scene {scene_num} with net_arch {net_archs[i]}")
            ...
            # Save results
            with open(f"/vol/bitbucket/av1019/PPO/hyperparameters/results/final_tuning_hp_{i}.json", "w") as f:
