...
if __name__ == '__main__':
    ...
    print(f"Running final model for scene {scene_num} with seed {final_seed}")
    ...
    # Save results
    with open(f"/vol/bitbucket/av1019/PPO/final_models/results/final_results_scene_{scene_num}_seed_{final_seed}.json", "w") as f:
