...
class ImageToPoseTrainerCoarse:
    ...
    def __init__(self, task_name, hyperparameters):
        ...
        self.image_to_pose_network = ImageToPoseNetworkCoarse(task_name)
        self.results_directory = self.bitbucket + str(task_name) + '/Image_To_Pose_Training_Coarse'
        ...
        data_file = '/vol/bitbucket/av1019/behavioural-cloning/hyperparameters/expert_data/data_10000_expert_data_height_pitcher_scene_1000000.pkl'
